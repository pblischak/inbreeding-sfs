...
ggsave("domestication_Nu2.pdf", units = "in", width=12, height=10)

df %>% ggplot(aes(x=F_true, y=T_est, group=F_true)) +
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.02), alpha=0.6) +
...
ggsave("domestication_T.pdf", units = "in", width=12, height=10)

df %>% ggplot(aes(x=F_true, y=M21_est, group=F_true)) +
  geom_boxplot() +
  geom_jitter(shape=16, position=position_jitter(0.02), alpha=0.6) +
...
ggsave("domestication_M21.pdf", units = "in", width=12, height=10)
