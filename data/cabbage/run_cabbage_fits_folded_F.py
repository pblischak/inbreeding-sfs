...
def expand_bottlegrowth(params,ns,pts):
    """
    This is the model that we used for inference.
    """
...
if __name__ == '__main__':
    ...
    upper_bound = [10.0,10.0,10.0,10.0,10.0,0.9999]
    lower_bound = [1e-2,1e-2,1e-2,1e-2,1e-2,0.0001]
    p0 = [2.0,0.5,1.0,1.0,1.0,0.5]
    ...
    with open("cabbage_fits_F_oldOpt.csv", 'a') as f1_out, open("cabbage_fits_F_newOpt.csv", 'a') as f2_out:
